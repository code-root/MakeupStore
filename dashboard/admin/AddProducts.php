		         ...
		         if ($uploadOk == 0) {
		           ...
		           // if everything is ok, try to upload file
		             ...
		             if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $path)) {
		                 ...
		                 $sql = "INSERT INTO products (name, price, img , Details , date , Status )
		                                         VALUES ('$name', '$price', '$new_file_name' , '$Details' , now() , 1 )";
                ...
                <form action="" method="POST" enctype="multipart/form-data" >
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" name="Details" type="text">
                        </div>
