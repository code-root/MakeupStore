...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
    ...
    <?php
         ...
         $sql = "UPDATE users SET Full_name = '$Full_name' , username = '$username' ,$passwordSQL number = '$number' , email = '$email'    WHERE id='$customerId' ";
                ...
                <form action="" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600"  value="" name="password" type="password">
                        </div>
