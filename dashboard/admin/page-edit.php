      ...
      if ($_SERVER['REQUEST_METHOD'] == 'GET') { 
        ...
        // exit;
		      ...
		      if (!isset($_POST['name']) == ''  & !isset($_POST['mes']) == '' ) {
               ...
               $sql = "UPDATE page SET  name = '$name' , txt = '$mes'  WHERE id='$pageID'";
            ...
            <div class="p-6 bg-white rounded-md shadow-md">
               ...
               <?php  if (isset($MasgSt)) {
                ...
                <div class="flex justify-center items-center w-12 bg-blue-500">
                    <svg class="h-6 w-6 fill-current text-white" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="-mx-3 py-2 px-4">
                            ...
                            <br>
                            <br>
                            <a href="page.php" class="px-6 py-3 bg-green-600 rounded-md text-white font-medium tracking-wide hover:bg-green-500 ml-3" > الرجوع لكافة الصفحات  </a>
                            ';
                ...
                <form action="" method="POST" enctype="multipart/form-data" >
                    ...
                    <div>
                            <label class="text-gray-900" for=""></label>
